 ...
 *
 * @param s Строка, которую нужно удалить.
 * @param root Указатель на корень бора.
...
```
/**
 * @brief Рекурсивно обходит бор для вывода строк.
 * 
...
```
/**
 * @brief Выводит все строки, хранящиеся в боре.
 * 
 ...
 *
 * @param s Строка, которую нужно найти.
 * @param root Указатель на корень бора.
